...
<body>
  ...
  <div class="app app-header-fixed" id="app" action="index.php">
    <div class="app-header navbar">
      ...
      <div class="collapse pos-rlt navbar-menu-wrapper navbar-collapse box-shadow bg-white-only" style="background: #2684D0;">
        ...
        <div class="contendor_kn">
          <div class="panel panel-default">
            <div class="panel-body">
              ...
              <img style="width: 800px;" src="descarga.png">
            </div>
            </div>  
          </div>
        </div>
    ...
    <div class="app-footer wrapper b-t bg-light">
      ...
      &copy; 2022 Copyright by<span><a href="https://itworld-ge.com" target="_blank">  ITWORLD.SL</a></span>
    </div>
    <!-- / footer -->
  </div>
  <!-- jQuery -->
